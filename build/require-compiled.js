...
(function(ga) {
    ...
    function Y(b, c, d, g) {
        c && D(c, function(c, e) {
            if (d || !x(b, e)) !g || "object" !== (typeof c === "undefined" ? "undefined" : (0, _typeof3.default)(c)) || !c || L(c) || K(c) || c instanceof RegExp ? b[e] = c : (b[e] || (b[e] = {}), Y(b[e], c, d, g));
        });
        return b;
    }
    ...
    function ma(b) {
        ...
        function r(a) {
            var n,
                b = a ? a.indexOf("!") : -1; - 1 < b && (n = a.substring(0, b), a = a.substring(b + 1, a.length));
            return [n, a];
        }
            ...
            makeRequire: function makeRequire(a, n) {
                ...
                Y(m, {
                    ...
                    toUrl: function toUrl(b) {
                        var d,
                            f = b.lastIndexOf("."),
                            g = b.split("/")[0]; - 1 !== f && ("." !== g && ".." !== g || 1 < f) && (d = b.substring(f, b.length), b = b.substring(0, f));
    ...
    if ("undefined" === typeof define) {
        ...
        "undefined" === typeof _require || K(_require) || (w = _require, _require = void 0);
        g = requirejs = function requirejs(b, c, d, m) {
            var r,
                q = "_";
